...
public class AppController {
  ...
  @RequestMapping(value = "cantOcupacion.htm", method = RequestMethod.GET)
  public ModelAndView obtenerCantOcupacion(){
	 List cantOcupacion = service.obtenerCantOcupacion();
	 ModelAndView view = new ModelAndView("ocupacion");
	 view.addObject("cantOcupacion", cantOcupacion);
	 return view;
  }
  
  @RequestMapping(value = "cantSalarioOcupacion.htm", method = RequestMethod.GET)
  public ModelAndView obtenerSalarioOcupacion(){
	 List salarioOcupacion = service.obtenerSalarioTotalOcupacion();
	 ModelAndView view = new ModelAndView("salario");
	 view.addObject("salarioOcupacion", salarioOcupacion);
	 return view;
  }
}
